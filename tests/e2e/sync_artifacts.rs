...
///      (engine-generated files must be readable by the upstream sqlite3 CLI).
...
fn e2e_sync_import_force_preserves_integrity_and_close_works() {
    ...
    // the previous engine's B-tree layer stops cleaning up after itself reliably.
    ...
    // that historically left the previous engine's B-tree/indexes inconsistent.
