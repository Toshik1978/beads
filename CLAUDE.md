...
A full run at the time of writing: **3152 tests, 0 failed, 4 skipped**, in 95s
...
nothing hidden in them; the paginated-envelope work for `search`/`blocked`
then added eight more, to 3152.
